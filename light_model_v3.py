...
# RFE 100 features
# def RFE_100():
#     print("RFE with 100 features")
#     # Feature extraction with Recursive feature elimination
#     model = LogisticRegression()
#     rfe_100 = RFE(model, 100)  # selecting top 100 features
#     fit_100 = rfe_100.fit(X, Y)
#     # print("Num features:", fit_100.n_features_)
#     # print("Selected features:", fit_100.support_)  # the features marked with 'True' are the selected features
#     # print("Feature ranking:", fit_100.ranking_)  # the '1' corresponds to the selected features
#     # print(fit_100.ranking_)
#
#     filter_condition = np.hstack((fit_100.ranking_ == 1, [False]))
...
def RFE_150():
    ...
    # Feature extraction with Recursive feature elimination
    model = LogisticRegression()
    rfe_150 = RFE(model, 150)  # selecting top 100 features
    fit_150 = rfe_150.fit(X, Y)
    # print("Num features:", fit_100.n_features_)
    # print("Selected features:", fit_100.support_)  # the features marked with 'True' are the selected features
    # print("Feature ranking:", fit_100.ranking_)  # the '1' corresponds to the selected features
    # print(fit_100.ranking_)

    filter_condition = np.hstack((fit_150.ranking_ == 1, [False]))
    filtered_matrix = array[:, filter_condition]
    # print(filtered_matrix)
    return filtered_matrix.astype(float), array[:, -1]
...
#     # Feature extraction with Recursive feature elimination
#     model = LogisticRegression()
#     rfe_100 = RFE(model, 200)  # selecting top 100 features
#     fit_100 = rfe_100.fit(X, Y)
#     # print("Num features:", fit_100.n_features_)
#     # print("Selected features:", fit_100.support_)  # the features marked with 'True' are the selected features
#     # print("Feature ranking:", fit_100.ranking_)  # the '1' corresponds to the selected features
...
#     # Feature extraction with Recursive feature elimination
#     model = LogisticRegression()
#     rfe_300 = RFE(model, 300)  # selecting top 100 features
#     fit_300 = rfe_300.fit(X, Y)
#     # print("Num features:", fit_100.n_features_)
#     # print("Selected features:", fit_100.support_)  # the features marked with 'True' are the selected features
#     # print("Feature ranking:", fit_100.ranking_)  # the '1' corresponds to the selected features
#     # print(fit_100.ranking_)
#
#     filter_condition = np.hstack((fit_300.ranking_ == 1, [False]))
#     filtered_matrix = array[:, filter_condition]
#     print(filtered_matrix)
#
#     return filtered_matrix.astype(float), array[:,-1]
...
# print(fit.components_,array[:,-1])
# x,y = fit.components_,array[:,-1]
# print(x.shape)
# x.reshape()
# # x.reshape((900,1))
# print(y)
...
for clf, label in zip(classifiers, labels):
    ...
    print("%0.2f%%" % (cross_val_score(clf, x, y, cv=10, scoring='accuracy').mean()*100))
