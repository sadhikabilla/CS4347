...
#    data = np.array(arff.load(open('librosa_mfcc_arff.arff'))['data'])
    ...
    x = np.hstack((data[:,:208], data[:,332:388], data[:,314:322], data[:,324:325], data[:,328:329]))    
...
eclf = VotingClassifier(estimators=[('svm', clf_svm), ('lda', clf_lda), ('rfc', clf_rfc)], voting='soft', weights=[1,2,1])
